...
Sub getItem
	...
	strSQL = "SELECT * FROM yma_roadshow_2014 WHERE item_id = " & intID
    ...
    if not DB_RecSetIsEmpty(rs) Then
		...
		session("how_displayed") 	= rs("how_displayed")
...
sub updateItem
	...
	strSQL = "UPDATE yma_roadshow_2014 SET "
	...
	strSQL = strSQL & "displayed = '" & Server.HTMLEncode(Trim(Request.Form("txtDisplay"))) & "',"
	strSQL = strSQL & "how_displayed = '" & Server.HTMLEncode(Trim(Request.Form("txtHowDisplay"))) & "',"
...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="first_content"><table cellpadding="5" cellspacing="0" border="0">
        <tr>
          <td valign="top"><img src="images/backward_arrow.gif" border="0" /> <a href="list_roadshow.asp">Back to List</a>
            <h2>Update Roadshow<u></u></h2>
          ...
          <tr>
            <td width="50%" valign="top"><table cellpadding="5" cellspacing="0" class="item_maintenance_box">
                ...
                <tr>
                  ...
                  <td><select name="cboSource">
                      ...
                      <option <% if session("source") = "New Loan" then Response.Write " selected" end if%> value="New Loan">New Loan</option>
            ...
            <td width="50%" valign="top"><table cellpadding="5" cellspacing="0" class="item_maintenance_box">
                ...
                <tr>
                  ...
                  <td><input type="text" id="txtDisplay" name="txtHowDisplay" maxlength="30" size="30" value="<%= session("how_displayed") %>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><textarea name="txtComment" id="txtComment" cols="35" rows="4"><%= session("comments") %></textarea></td>
                </tr>
