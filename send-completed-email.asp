...
<title>Freight - Send Completed Email Notification</title>
<link rel="stylesheet" href="include/stylesheet.css" type="text/css" />
<script type="text/javascript" src="include/validations.js"></script>
<%
'-----------------------------------------------------------------------------
' SEND EMAIL notification to the requester when the freight is completed
'-----------------------------------------------------------------------------
sub sendCompletedEmail
	...
	emailBodyText   = 	"Hi there," & vbCrLf _						
					&	"" & vbCrLf _
					&	"Your freight request created at " & session("date_created") & " to " & session("receiver_name") & " at " & session("receiver_address") & ", " & session("receiver_city") & " has been completed." & vbCrLf _
					&	"" & vbCrLf _
					&	"Thank you." & vbCrLf _
					&	""  & vbCrLf _
	...
	strMessageText = "An email has been sent to notify the requester that the freight has been completed."
end sub

sub main
	call UTL_validateLogin  
	call sendCompletedEmail
end sub
