...
set rs=server.createobject("ADODB.recordset")
	...
	strSQL = strSQL & "	WHERE (supplier_invoice_no LIKE '%" & strSearch & "%' "
	strSQL = strSQL & "			OR container_no LIKE '%" & strSearch & "%' "
	strSQL = strSQL & "			OR EFT LIKE '%" & strSearch & "%' "
	strSQL = strSQL & "			OR vessel_name LIKE '%" & strSearch & "%') "
	strSQL = strSQL & "		AND department LIKE '%" & strDepartment & "%' "
	strSQL = strSQL & "		AND country_origin LIKE '%" & strCountry & "%' "
	strSQL = strSQL & "		AND warehouse LIKE '%" & strWarehouse & "%' "
	strSQL = strSQL & "		AND fta_status LIKE '%" & strFTA & "%' "
	strSQL = strSQL & "		AND YEAR(date_created) = '" & strYear & "' "
...
Response.AddHeader "Content-Disposition", "attachment; filename=past-shipment-"& strYear & "_list.xls"
