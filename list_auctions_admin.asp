	...
	if not DB_RecSetIsEmpty(rs) Then
		...
		For intRecord = 1 To rs.PageSize
			...
			'if rs("winning_bid") <> "" then
				...
				strDisplayList = strDisplayList & "<td align=""center""><input type=""text"" id=""txtWinningBid"" name=""txtWinningBid"" maxlength=""5"" size=""5"" value=""" & rs("winning_bid") & """ ></td>"
			'else
			'	strDisplayList = strDisplayList & "<td align=""center"">-</td>"
			'end if
			'strDisplayList = strDisplayList & "<td align=""center"">" & rs("winner") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center""><input type=""text"" id=""txtWinner"" name=""txtWinner"" maxlength=""20"" size=""20"" value=""" & rs("winner") & """ ></td>"
...
sub updateAuction
	...
	intWinningBid 	= Trim(Request.Form("txtWinningBid"))
	strWinner 		= Trim(Request.Form("txtWinner"))
	...
	strSQL = strSQL & "winning_bid = '" & Server.HTMLEncode(intWinningBid) & "',"
	strSQL = strSQL & "winner = '" & Server.HTMLEncode(strWinner) & "',"
