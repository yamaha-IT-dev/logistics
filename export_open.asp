...
sql = "SELECT * FROM yma_shipment WHERE status = 1 ORDER BY eta_unpacked DESC, eta_discharged DESC, supplier_invoice_no"
...
Response.AddHeader "Content-Disposition", "attachment; filename=shipment_open.xls"
