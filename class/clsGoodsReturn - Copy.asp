...
function getGraFromBASE(intID)
	...
	strSQL = strSQL & " Y1KOM1, Y1JSO1, Y1JSO3, Y1KNCI, Y1UBNB, Y1TELN, YMOPEC, YMOPNM, YMSKKI "
	...
	strSQL = strSQL & "		WHERE "
	strSQL = strSQL & "			(YMPMID like 'LOG%' or YMPMID like 'INT%' or YMPMID like 'SERV%' or YMPMID like 'CREDIT%') "
