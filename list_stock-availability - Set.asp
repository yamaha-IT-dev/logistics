...
function searchStock(){    
    ...
    document.location.href = 'list_stock-availability.asp?type=search&txtSearch=' + strSearch + '&cboDepartment=' + strDept + '&cboItemType=' + strItemType + '&cboWarehouse=' + strWarehouse;
}
...
sub displayStockAvailability
	...
	strSQL = strSQL & "	Y3SOMB as Y3SYME, Y3STIK, Y1.YINWPR AS RRP, Y2.YINWPR AS S01 "
	strSQL = strSQL & " 	FROM AF5SP "
	strSQL = strSQL & "			INNER JOIN YF3MP ON A5SOSC = Y3SOSC "
	strSQL = strSQL & "			left JOIN EF2SP ON A5SOSC = E2SOSC "
	strSQL = strSQL & "			left JOIN YFIMP Y1 ON A5SOSC = Y1.YISOSC "	
	strSQL = strSQL & "			left JOIN YFIMP Y2 ON A5SOSC = Y2.YISOSC "			
	strSQL = strSQL & "			WHERE A5SOSC LIKE '%" & UCASE(trim(session("stockavail_search"))) & "%' "
	if trim(session("stockavail_warehouse")) = "" then
		strSQL = strSQL & "				AND (A5SOCD LIKE '%3S%' OR A5SOCD LIKE '%3XL%')"
	else
	...
	strSQL = strSQL & "				AND Y3STIK IN  (" & UCASE(trim(session("stockavail_item_type"))) & ") "
	...
	if not DB_RecSetIsEmpty(rs) Then
		...
		For intRecord = 1 To rs.PageSize 
			...
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5SOSC") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("Y3SYME") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & FormatNumber(rs("RRP")) & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & FormatNumber(rs("S01")) & "</td>"
			'strDisplayList = strDisplayList & "<td align=""center"">" & FormatNumber(rs("LIC")) & "</td>"
			strDisplayList = strDisplayList & "<td align=""center""></td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5JZSU") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5JZKH") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5JZHS") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("AVAILOH") & "</td>"	
			strDisplayList = strDisplayList & "<td align=""center""></td>"		
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5MCHS") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5MHKS") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5MHZS") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("AVAILIT") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5JUSG") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("A5SOCD") & "</td>"		
	...
	strDisplayList = strDisplayList & "<td align=""center""><b>Total of this page: </b></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intOnHandsTotal & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intOnHandsTotalReserved & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intOnHandsTotalAllocated & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intOnHandsTotalAvailable & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intInTransitTotal & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intInTransitTotalReserved & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intInTransitTotalAllocated & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intInTransitTotalAvailable & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""><b>" & intTotalBackorder & "</b></td>"
	strDisplayList = strDisplayList & "<td align=""center""></td>"		
	strDisplayList = strDisplayList & "</tr>"			
	strDisplayList = strDisplayList & "<tr>"
...
sub main
	session("stockavail_item_type") = "0, 3"
...
<table cellspacing="0" cellpadding="0" align="center" class="full_size_table" border="0">
          ...
          <td valign="top"><div class="alert alert-search">
              <form name="frmSearch" id="frmSearch" method="post" action="list_stock-availability.asp?type=search" onsubmit="searchStock()">Search Product code:
                ...
                <select name="cboItemType" onchange="searchStock()" class="form-control">
                  <option <% if session("stockavail_item_type") = "'0', '3'" then Response.Write " selected" end if%> value="'0', '3'">Not Set Items</option>
                ...
                <select name="cboWarehouse" onchange="searchStock()" class="form-control">
                  <option <% if session("stockavail_warehouse") = "" then Response.Write " selected" end if%> value="">Both 3S and 3XL</option>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="5" class="database_records">
        <tr class="innerdoctitle" align="center" style="font-size:medium">
