              ...
              <table border="0" cellpadding="5" cellspacing="0" width="1000">
                <tr>
                  <td width="50%" valign="top"><table cellpadding="5" cellspacing="0" class="item_maintenance_box">
                    ...
                    <label for="chkTransit">In Transit</label> <img src="images/icon_new.gif" border="0" align="top" /></td>
                      ...
                      <tr>
                        <td>EFT:<br />
                          <input type="text" id="txtEFT" name="txtEFT" maxlength="6" size="6" value="<%= session("EFT") %>" /></td>
                ...
                <tr>
                  <td valign="top" colspan="2"><input type="hidden" name="Action" />
                    <input type="submit" value="Update Shipment" <% if session("status") = "0" and session("UsrUserName") <> "craigd" and session("UsrUserName") <> "yvonnem" and session("UsrUserName") <> "kurtt" and session("UsrUserName") <> "christineb" then Response.Write "disabled" end if%> /></td>
                </tr>
              </table>
            </form></td>
