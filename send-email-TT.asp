...
sub sendTransferPickupEmail
		...
		JMail.Subject		= "(3K - TT) Transfer Request has been picked up"
		JMail.Sender		= "au_webmaster@gmx.yamaha.com"
		JMail.SenderName	= "Yamaha Logistics"
		
		JMail.AddRecipient = ("YMA-Warehouse@ttlogistics.com.au")
		JMail.AddRecipient = ("logistics-aus@music.yamaha.com")
				
		JMail.Body    	= "Hi Sam," & vbCrLf _
						& "" & vbCrLf _
						& "Your transfer request from 3K to TT has been picked up." & vbCrLf _
						& "" & vbCrLf _
						& "Thank you." & vbCrLf _
						& ""  & vbCrLf _
