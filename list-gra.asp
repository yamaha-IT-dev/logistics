...
function searchItem(){    
    ...
    document.location.href = 'list-gra.asp?type=search&txtSearch=' + strSearch + '&operator=' + strOperator + '&month=' + strMonth + '&year=' + strYear + '&warehouse=' + strWarehouse + '&status=' + strStatus;
}
    
function resetSearch(){
	document.location.href = 'list-gra.asp?type=reset';    
}  
</script>
</head>
<body>
...
sub displayGRA
	...
	strDisplayList = strDisplayList & "<form name=""MovePage"" action=""list-gra.asp"" method=""post"">"
    ...
    <td class="first_content"><table cellpadding="5" cellspacing="0" border="0">
        <tr>
          ...
          <td valign="top"><div class="alert alert-search">
              <form name="frmSearch" id="frmSearch" action="list-gra.asp?type=search" method="post" onsubmit="searchItem()">
      ...
      <p><span class="current_header">Goods Return BASE</span> &nbsp;-&nbsp; <a href="list-gra_report.asp">Report Summaries</a> &nbsp;-&nbsp; <a href="list-gra_report_writeoffs.asp">Write Offs Report</a> &nbsp;-&nbsp; <a href="list-gra_report_exported.asp">Exported Report</a> &nbsp;-&nbsp; <a href="list_pallet.asp">Pallets</a></p></td>
  </tr>
  <tr>
