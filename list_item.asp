...
function searchItem(){
    ...
    //if (strSearch != ''){
     	document.location.href = 'list_item.asp?type=search&txtSearch=' + strSearch + '&cboOwner=' + strItemOwner + '&cboReturnTo=' + strReturnTo + '&cboOrigin=' + strItemOrigin + '&cboDepartment=' + strItemDepartment + '&cboSkuType=' + strSkuType + '&cboTransit=' + strTransit + '&cboCategory=' + strCategory;
    //}
}

function resetSearch(){
	document.location.href = 'list_item.asp?type=reset';
}
</script>
</head>
<body>
...
sub displayItem
	...
	strDisplayList = strDisplayList & "<form name=""MovePage"" action=""list_item.asp"" method=""post"">"
