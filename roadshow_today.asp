...
function searchItem(){    
    ...
    //if (strSearch != ''){
     	document.location.href = 'roadshow_today.asp?type=search&txtSearch=' + strSearch + '&cboOwner=' + strItemOwner + '&cboReturnTo=' + strReturnTo + '&cboOrigin=' + strItemOrigin + '&cboDepartment=' + strItemDepartment + '&cboSkuType=' + strSkuType;
    //}            
}
    
function resetSearch(){
	document.location.href = 'roadshow_today.asp?type=reset';    
}  
</script>
</head>
<body>
...
sub displayItem	
	...
	'(date_modified >= '" & strTodayDate & "' OR date_created  >= '" & strTodayDate & "') AND
	...
	if not DB_RecSetIsEmpty(rs) Then
		...
		For intRecord = 1 To rs.PageSize 
			...
			'if rs("date_modified") = "2011-06-06" then
	...
	strDisplayList = strDisplayList & "<form name=""MovePage"" action=""roadshow_today.asp"" method=""post"">"
...
<table cellspacing="0" cellpadding="0" align="center" class="full_size_table">
  <tr>
    <td class="first_content"><h2>Focus Roadshow 2011 Product List (Updated Today)</h2>
     <p><a href="roadshow.asp">All</a> | Updated Today</p>
