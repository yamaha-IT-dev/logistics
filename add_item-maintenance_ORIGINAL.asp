...
sub addItemMaintenance
	...
	strSQL = strSQL & " fob, trade, rrp, nz_trade, "
	...
	strSQL = strSQL & "'" & strFOB & "', '" & strTrade & "', '" & strRRP & "', '" & strNzTrade & "',"
	...
	if error <> 0 then
		...
		Select Case strDepartment
			...
			case "MPD"
				emailTo  	= "mark.amory@music.yamaha.com"
        ...
        <table border="0" cellpadding="3" cellspacing="0" class="wide_table">
          <tr>
            <td width="33%" align="left" valign="top"><table cellpadding="3" cellspacing="0" class="item_maintenance_box">
                ...
                <tr>
                  <td>GMC code:</td>
                  <td><input type="text" id="txtGMCcode" name="txtGMCcode" maxlength="20" size="30" /></td>
                </tr>
                <tr>
                  <td>Sales group:</td>
                ...
                <tr rel="multicolour">
                  <td colspan="2"><table cellpadding="0" cellspacing="0" width="100%" border="0">
                      ...
                      <tr class="documents_all">
                        ...
                        <td width="20%" align="left"><input type="text" id="txtGMC1" name="txtGMC1" maxlength="15" size="10" /></td>
                        <td width="15%" align="left"><input type="text" id="txtEAN1" name="txtEAN1" maxlength="15" size="10" /></td>
                        ...
                        <td colspan="5"><div class="thecontent">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tr class="documents_all">
                                ...
                                <td width="20%" align="left"><input type="text" id="txtGMC2" name="txtGMC2" maxlength="15" size="10" /></td>
                                <td width="15%" align="left"><input type="text" id="txtEAN2" name="txtEAN2" maxlength="15" size="10" /></td>
                                <td width="5%"><h3 class="myheadings">+color</h3></td>
                              </tr>
                            </table>
                          </div></td>
                        ...
                        <td colspan="5"><div class="thecontent">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tr class="documents_all">
                                ...
                                <td width="20%" align="left"><input type="text" id="txtGMC3" name="txtGMC3" maxlength="15" size="10" /></td>
                                <td width="15%" align="left"><input type="text" id="txtEAN3" name="txtEAN3" maxlength="15" size="10" /></td>
                                <td width="5%"><h3 class="myheadings">+color</h3></td>
                              </tr>
                            </table>
                          </div></td>
                        ...
                        <td colspan="5"><div class="thecontent">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tr class="documents_all">
                                ...
                                <td width="20%" align="left"><input type="text" id="txtGMC4" name="txtGMC4" maxlength="15" size="10" /></td>
                                <td width="15%" align="left"><input type="text" id="txtEAN4" name="txtEAN4" maxlength="15" size="10" /></td>
                                <td width="5%"><h3 class="myheadings">+color</h3></td>
                              </tr>
                            </table>
                          </div></td>
                        ...
                        <td colspan="5"><div class="thecontent">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tr class="documents_all">
                                ...
                                <td width="20%" align="left"><input type="text" id="txtGMC5" name="txtGMC5" maxlength="15" size="10" /></td>
                                <td width="20%" align="left"><input type="text" id="txtEAN5" name="txtEAN5" maxlength="15" size="10" /></td>
                                <td width="5%">&nbsp;</td>
                              </tr>
                            </table>
                          </div></td>
            ...
            <td width="33%" valign="top"><table cellpadding="3" cellspacing="0" class="item_maintenance_box">
              ...
              <table cellpadding="3" cellspacing="0" class="item_maintenance_box">
                ...
                <tr>
                  <td>EAN code:</td>
                  <td><input type="text" id="txtEANcode" name="txtEANcode" maxlength="30" size="40" /></td>
                </tr>
              </table></td>
            <td width="33%" valign="top"><table cellpadding="3" cellspacing="0" class="item_maintenance_box">
                <tr>
