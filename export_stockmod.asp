...
strSQL = "SELECT * FROM yma_changeover WHERE state LIKE '%" & strState & "%' AND (customer LIKE '%" & strSearch & "%' OR contact_person LIKE '%" & strSearch & "%' OR old_model LIKE '%" & strSearch & "%') AND status LIKE '%" & intStatus & "%'"
