...
sub sendTransferPickupEmail		
	...
	emailSubject 	= "Your Transfer Request (" & session("warehouse") & ") has been picked up"
		
	emailBodyText   = "Hi Sam," & vbCrLf _
					& "" & vbCrLf _
					& "The transfer request from " & session("warehouse") & " created at " & session("date_created") & " has been picked up." & vbCrLf _
					& "" & vbCrLf _
					& "Thank you." & vbCrLf _
					& "" & vbCrLf _
	...
	strMessageText = "An email has been sent to Sam (TT Logistics) informing that the transfer has been picked up."
end sub
